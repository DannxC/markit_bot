...
SELECT 
	...
	,IIF(ISNULL(ord.upfront_0010, 0) = 0, NULL, ord.upfront_0010)																	AS Valor_Upfront

	,IIF(ISNULL(ord.upfront_0010, 0) = 0, NULL, moe_upfront.cod_bbm_0042)															AS Moeda_Upfront
	,IIF(ISNULL(ord.upfront_0010, 0) = 0, NULL, ord.dat_liq_0010)																	AS Data_Liquidacao
...
SELECT
	...
	,CASE 
		WHEN mrkit_header_Party_A_0964 = cod_ext.cod_ext_0443		THEN  'partyA'
		WHEN mrkit_header_Party_B_0964 = cod_ext.cod_ext_0443		THEN  'partyB'
		ELSE ''
	 END
FROM 
...
ORDER BY 
	markit.mrkit_header_Trade_Date_0964 DESC
...
SELECT 
	...
	,ISNULL(ord.Cleared, markit.Client_Clearing)													AS Cleared
